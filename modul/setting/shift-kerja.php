...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Pembagian Jam Kerja</h3>
	...
	<div class="modal fade" id="editTema">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="updateTemaForm" method="POST" action="modul/setting/update-shift.php" class="form" autocomplete="off">
	...
	<div class="modal fade" id="tambahTema">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form" action="modul/setting/tambah-jam.php" method="POST" id="tambahLibur" autocomplete="off">
						<div class="modal-header">
							<h5 class="modal-title">Pembagian Jam Kerja</h5>
						...
						<div class="modal-body">
							<div class="form-group form-group-default row">
								<div class="form-group col-md-6 border-top-0 pt-0">
									...
									<div class="input-group">
										...
										<input type="text" id="tanggal_awal" name="tanggal1" class="form-control"  required>
									</div>
								</div>
								<div class="form-group col-md-6 border-top-0 pt-0">
									<label for="inputCity">Tanggal Awal</label>
									<div class="input-group">
										...
										<input type="text" id="tanggal_akhir" name="tanggal2" class="form-control"  required>
									</div>
								</div>
							</div>
							<div class="form-group form-group-default">
								...
								<div class="input-group">
									...
									<input type="text" id="jam1" name="jam1" class="form-control"  required>
								</div>
							</div>
							<div class="form-group form-group-default">
								...
								<div class="input-group">
									...
									<input type="text" id="jam2" name="jam2" class="form-control"  required>
								</div>
							</div>							
						</div>
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/setting/daftar-jam.php"
		});
	...
	function removeShift(id = null) {
		if(id) {
			// click on remove button
			
			Swal.fire({
			  title: 'Yakin dihapus?',
			  text: "Apakah anda yakin Menghapus Shift ini?",
			  icon: 'warning',
			  ...
			  if (result.isConfirmed) {
				$.ajax({
						url: 'modul/setting/hapus-jam.php',
						type: 'post',
						data: {tema : id},
						dataType: 'json',
						success:function(response) {
