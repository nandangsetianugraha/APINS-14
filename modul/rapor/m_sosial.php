...
<!-- Connections -->
				<div class="modal-header">
					<h5 class="modal-title">Rapor Sosial <?=$siswa['nama'];?></h5>
				...
				<div class="modal-body">
					...
					<div class="form-group form-group-default">
						...
						<textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Deskripsi Sosial.."><?=$utt['deskripsi'];?></textarea>
					</div>
				</div>
