				...
				<div class="menu">
					...
					<div class="menu-section">
                  	...
                  	<div class="menu-item">
						...
						<div class="menu-submenu">
							...
							<div class="menu-item">
								<a href="<?=base_url();?>status-server" data-menu-path="<?=base_url();?>" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Status Server</span>
								</a>
							</div>
							<div class="menu-item">
								<a href="<?=base_url();?>identitas-sekolah" data-menu-path="<?=base_url();?>" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Identitas Sekolah</span>
								</a>
							</div>
							<div class="menu-item">
                    ...
                    <div class="menu-item">
						<button class="menu-item-link menu-item-toggle">
							...
							<span class="menu-item-text">Data Nilai US</span>
							<div class="menu-item-addon">
								<i class="menu-item-caret caret"></i>
							</div>
						</button>
						...
						<div class="menu-submenu">
							<div class="menu-item">
								<a href="<?=base_url();?>nilai-us" data-menu-path="<?=base_url();?>" class="menu-item-link">
									<i class="menu-item-bullet"></i>
									<span class="menu-item-text">Nilai US</span>
								</a>
							</div>
						</div>
						<!-- END Menu Submenu -->
