    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Wali Kelas</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
		...
		<div class="section mt-2">
            <div class="profile-head">
                ...
                <div class="in">
                    ...
                    <h5 class="subtext">Wali Kelas <?=$kelas;?></h5>
                </div>
            </div>
        </div>
                                ...
                                <div class="in">
                                    <div class="form-group basic">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" class="form-control" value="<?=$wali['nama'];?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
										...
										<div class="in">
											<div class="form-group basic">
												<div class="input-wrapper">
													...
													<input type="text" class="form-control" value="<?php if($wali['jenis_kelamin']=='L'){echo "Laki-laki";}else{echo "Perempuan";} ?>" readonly>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="in">
											<div class="form-group basic">
												<div class="input-wrapper">
													...
													<input type="text" class="form-control" value="<?=$wali['niy_nigk'];?>" readonly>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="in">
											<div class="form-group basic">
												<div class="input-wrapper">
													...
													<input type="text" class="form-control" value="<?=$wali['nuptk'];?>" readonly>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="in">
											<div class="form-group basic">
												<div class="input-wrapper">
													...
													<input type="text" class="form-control" value="<?=$wali['alamat_jalan'];?>" readonly>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="in">
											<div class="form-group basic">
												<div class="input-wrapper">
													...
													<input type="text" class="form-control" value="<?=$wali['no_hp'];?>" readonly>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="in">
											<div class="form-group basic">
												<div class="input-wrapper">
													...
													<input type="text" class="form-control" value="<?=$wali['email'];?>" readonly>
												</div>
											</div>
										</div>
									</div>
