    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Sumatif Akhir Semester</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
		...
		<div class="section full mt-2">
            <div class="section-title">Sumatif Akhir Semester</div>
								...
								<table class="table">
									...
									while($mp=$query4->fetch_assoc()){
										if($ab<2 and $mp['id_mapel']==5){
											...
											$mpl=$mp['id_mapel'];
											$nilai = $connect->query("select * from sas where id_pd='$idku' and smt='$smt_aktif' and tapel='$tapel_aktif' and mapel='$mpl'")->fetch_assoc();
									?>
										<tr>
											<td><?=$mp['nama_mapel'];?></td>
											<td><?=$nilai['nilai'];?></td>
