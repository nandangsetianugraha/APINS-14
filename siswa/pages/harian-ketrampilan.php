    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Penilaian Ketrampilan</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
		...
		<div class="section full mt-2">
            <div class="section-title">Penilaian Ketrampilan</div>
					...
					<div class="col-12">
						<div class="form-group boxed">
							<div class="input-wrapper">
								...
								<input type="hidden" id="tipe" value="4">
	  ...
	  $(document).ready(function() {
		  $(document).on('click', '#getLaporan', function(e){
				...
				var pdid=$('#pdid').val();
					$.ajax({
						type : 'GET',
						url : 'modul/nilai-harian.php',
						data :  'tapel=' + tapel+'&pdid='+pdid+'&smt='+smt+'&mapel='+mapel+'&kelas='+kelas+'&tipe='+tipe,
						beforeSend: function()
						{	
