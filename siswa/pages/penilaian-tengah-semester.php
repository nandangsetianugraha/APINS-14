    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Penilaian Tengah Semester</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
		...
		<div class="section full mt-2">
            <div class="section-title">Penilaian Tengah Semester</div>
							...
							<div class="input-wrapper">
								...
								<select class="form-control custom-select" id="mapel" name="mapel">
									...
									while($mp=$query4->fetch_assoc()){
										if($ab<4 and ($mp['id_mapel']==5 or $mp['id_mapel']==6)){
											//kosongkan
										}else{
									?>
	  ...
	  $(document).ready(function() {
		  $(document).on('click', '#getLaporan', function(e){
				...
				var pdid=$('#pdid').val();
					$.ajax({
						type : 'GET',
						url : 'modul/nilai-pts.php',
						data :  'tapel=' + tapel+'&pdid='+pdid+'&smt='+smt+'&mapel='+mapel+'&kelas='+kelas,
						beforeSend: function()
						{	
							...
							$("#getLaporan").html('<span class="spinner-border spinner-border-sm mr-05" role="status" aria-hidden="true"></span> Loading...');
						},
