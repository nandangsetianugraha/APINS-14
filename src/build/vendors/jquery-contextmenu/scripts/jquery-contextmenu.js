                ...
                $.each(opt.items, function (key, item) {
                    ...
                    if (item.type && types[item.type]) {
                        ...
                        switch (item.type) {
                            ...
                            case 'checkbox':
                                $input = $('<input class="form-check-input" type="checkbox" value="1" name="" />')
                                    .attr('name', 'context-menu-input-' + key)
                                    .val(item.value || '')
                            ...
                            case 'radio':
                                $input = $('<input class="form-check-input" type="radio" value="1" name="" />')
                            ...
                            case 'select':
                                $input = $('<select class="form-select" name=""></select>')
                                    .attr('name', 'context-menu-input-' + key)
                                    .appendTo($label);
                                if (item.options) {
