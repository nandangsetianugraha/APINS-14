    ...
    var SearchPane = /** @class */ (function () {
        ...
        function SearchPane(paneSettings, opts, index, panesContainer, panes) {
            ...
            this.dom = {
                ...
                clear: $$5('<button type="button"><i class="fa fa-times"></i></button>')
                    .attr('disabled', 'true')
                ...
                container: $$5('<div/>')
                    ...
                    : ''),
                countButton: $$5('<button type="button"><i class="fa fa-sort-amount-down"></i></button>')
                    .addClass(this.classes.paneButton)
                ...
                nameButton: $$5('<button type="button"><i class="fa fa-sort-alpha-up"></button>')
                    .addClass(this.classes.paneButton)
                ...
                searchButton: $$5('<button type="button"><i class="fa fa-search"></i></button>')
