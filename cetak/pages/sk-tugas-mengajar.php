 ...
 **/
   ...
   $pdf->Ln(0.5);
   $pdf->SetFont('Times','B','12');
   $pdf->Cell(0,0,'Nomor: 421.2/040-SDI/I/2024',0,0,'C');
   $pdf->Ln(0.7);
   ...
   $pdf->Ln(0.5);
   $pdf->Cell(0,0,'SEMESTER 1 (GANJIL) TAHUN PELAJARAN 2022/2023',0,0,'C');
   $pdf->Ln(0.9);
   ...
   $pdf->Cell(0.4,0.5,':',0,0,'L');
   $pdf->MultiCell(15.5,0.5,'Pembagian Tugas Mengajar dan Tugas Tambahan pada Guru SD Islam Al-Jannah pada Semester 1 (Ganjil) Tahun Pelajaran 2022/2023 meliputi pembagian tugas mengajar oleh setiap guru bidang studi dalam melaksanakan kewajiban mengajar dan tugas tambahan lainnya.',0,'J',0);
   $pdf->Ln(0.1);
   ...
   $pdf->Cell(0.4,0.5,':',0,0,'L');
   $pdf->MultiCell(14,0.5,'Pembagian Tugas Mengajar dan Tugas Tambahan Guru Semester 1 Tahun Pelajaran 2023/2024',0,'J',0);
   $pdf->Ln(0.1);
   $pdf->Cell(2,0.5,'Nomor',0,0,'L');
   $pdf->Cell(0.4,0.5,':',0,0,'L');
   $pdf->MultiCell(11,0.5,'421.2/sdd/ss/2024',0,'J',0);
   $pdf->Ln(0.1);
   ...
   $pdf->Cell(0,0,'SEKOLAH DASAR ISLAM AL-JANNAH',0,0,'C');
   $pdf->Ln(0.5);
   $pdf->Cell(0,0,'SEMESTER 2 (GENAP) TAHUN PELAJARAN 2023/2024',0,0,'C');
   $pdf->Ln(0.9);
   ...
   $pdf->Ln();
   $ekstra = "select * from rombel where tapel='$tapel_aktif' and smt='$smt_aktif'";
