<?php
 ...
 include '../inc/db_connect.php';
	...
	$smt=$_GET['smt'];
		...
		$sql1 = "select * from penempatan where rombel='$kelas' and tapel='$tapel' and smt='$smt' order by nama asc";
		...
		while ($nm = $query1->fetch_assoc()) {
			$idp=$nm['peserta_didik_id'];
			$table3->rowStyle('font-size:12; min-height:10');
			$table3->easyCell($nm['nama'],'align:L;valign:M');
