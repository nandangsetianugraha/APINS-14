<?php $data="Pemetaan Kompetensi Dasar";?>
...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Pemetaan Kompetensi Dasar</h3>
	...
	$(document).ready(function(){
		...
		TabelP = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/administrasi/petaKD.php?kelas="+kelas+"&smt="+smt+"&peta=3&mp=0"
		});
		TabelK = $("#datatable-2").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/administrasi/petaKD.php?kelas="+kelas+"&smt="+smt+"&peta=4&mp=0"
		});
	...
	function removeKD(id = null) {
		if(id) {
			...
			Swal.fire({
			  title: 'Yakin dihapus?',
			  text: "Apakah anda yakin menghapus Peta KD ini?",
			  icon: 'warning',
