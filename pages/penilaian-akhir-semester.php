<?php $data="Penilaian Akhir Semester";?>
...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Penilaian Akhir Semester</h3>
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/penilaian/NilaiSemester.php?mp="+ mp+"&kelas="+kelas+"&smt="+smt+"&peta="+peta+"&tapel="+tapel+"&kd="+kd
		});
		...
		$('#kelas').change(function(){
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/NilaiSemester.php?mp="+ mp+"&kelas="+kelas+"&smt="+smt+"&peta="+peta+"&tapel="+tapel+"&kd=0"
			});
		});
		$('#mp').change(function(){
			var kd = $('#kd').val();
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/NilaiPAS.php?mp="+ mp+"&kelas="+kelas+"&smt="+smt+"&peta="+peta+"&tapel="+tapel+"&kd=0"
			});
		...
		$('#kd').change(function(){
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/NilaiPAS.php?mp="+ mp+"&kelas="+kelas+"&smt="+smt+"&peta="+peta+"&tapel="+tapel+"&kd="+kd
			});
	...
	function saveUA(editableObj,column,id,kelas,smt,tapel,mpid,kd) {
		...
		$.ajax({
			url: "modul/penilaian/saveNPAS.php",
			cache: false,
