...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Cetak Rapor P5</h3>
								...
								<div class="portlet-body">
									<div class="alert alert-outline-secondary">
										...
										<div class="alert-content">Menu Cetak akan muncul jika semua isian pada Penilaian P5 sudah terisi semua.</div>
									</div>
									<!-- BEGIN Datatable -->
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/proyek/rapor-p5.php?kelas="+kelas+"&tapel="+tapel+"&smt="+smt
		});
