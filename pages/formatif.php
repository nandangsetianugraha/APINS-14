	...
	$(document).ready(function(){
		...
		$('#mp').change(function(){
			...
			$.ajax({
				...
				success: function (data) {
					//jika data berhasil didapatkan, tampilkan ke dalam option select mp
					$("#materi").html(data);
					$("#nilaiHarian").html('<div class="alert alert-primary"><div class="alert-icon"><i class="fa fa-archive"></i></div><div class="alert-content">Silahkan Pilih Materi</div></div>');
				}
			});
			var materi = $('#materi').val();
		...
		$('#materi').change(function(){
			...
			$.ajax({
				...
				data :  'kelas='+kelas+'&mp='+mp+'&lm='+materi+'&smt='+smt+'&tapel='+tapel,
				beforeSend: function()
				{	
					$("#nilaiHarian").html('<div class="alert alert-primary"><div class="alert-icon"><i class="fa fa-spinner fa-pulse fa-fw"></i></div><div class="alert-content">Loading ...</div></div>');
				},
