<?php $data="Penilaian Akhir Semester DTA";?>
...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
	...
	$(document).ready(function(){
		...
		$('#kelas').change(function(){
			...
			$.ajax({
				type : 'GET',
				url : 'modul/penilaian/pas-dtas.php',
	...
	function savePASDTA(editableObj,column,id,kelas,smt,tapel,mpid) {
		...
		$.ajax({
			url: "modul/penilaian/savePASDTA.php",
			cache: false,
