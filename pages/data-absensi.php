...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Data Absensi</h3>
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/rapor/data-absensi.php?kelas="+kelas+"&tapel="+tapel+"&smt="+smt
		});
	...
	function removeDataAbsensi(id = null) {
		if(id) {
			// click on remove button
			
			Swal.fire({
			  title: 'Yakin dihapus?',
			  text: "Apakah anda yakin menghapus Data Absensi ini?",
			  icon: 'warning',
			  ...
			  if (result.isConfirmed) {
				$.ajax({
						url: 'modul/rapor/hapus-data-absensi.php',
						type: 'post',
						data: {member_id : id},
						dataType: 'json',
						success:function(response) {
