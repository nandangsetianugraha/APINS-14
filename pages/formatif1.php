...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Penilaian Formatif</h3>
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/penilaian/formatif.php?kelas="+kelas+"&smt="+smt+"&lm="+materi+"&mp="+mp+"&tp="+tpem+"&tapel="+tapel
		});
		...
		$('#kelas').change(function(){
			...
			$.ajax({
				...
				success: function (data) {
					...
					$("#tpem").html('<select class="form-select" id="tpem" name="tpem"><option value="0">Pilih Tujuan Pembelajaran</option></select>');
					$('#status').unblock();
				}
			});
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/formatif.php?kelas="+kelas+"&smt="+smt+"&lm=0&mp=0&tp=0&tapel="+tapel
			});
		});
		$('#mp').change(function(){
			var kelas=$('#kelas').val();
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/formatif.php?kelas="+kelas+"&smt="+smt+"&lm=0&mp="+mp+"&tp=0&tapel="+tapel
			});
		...
		$('#materi').change(function(){
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/formatif.php?kelas="+kelas+"&smt="+smt+"&lm="+materi+"&mp="+mp+"&tp=0&tapel="+tapel
			});
