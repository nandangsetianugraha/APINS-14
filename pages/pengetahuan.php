<?php $data="Penilaian Pengetahuan";?>
...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Penilaian Pengetahuan</h3>
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/penilaian/NilaiPeng.php?mp="+ mp+"&kelas="+kelas+"&smt="+smt+"&peta="+peta+"&tema="+tema+"&tapel="+tapel+"&kd="+kd+"&jns="+jns
		});
		...
		$('#kd').change(function(){
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/NilaiPeng.php?mp="+ mp+"&kelas="+kelas+"&smt="+smt+"&peta="+peta+"&tema="+tema+"&tapel="+tapel+"&kd=0&jns="+jns
			});
