...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Tambah Pengumuman</h3>
									<div class="portlet-addon">
										<a href="<?=base_url();?>" class="btn btn-danger modal-confirm">Kembali</a>
									</div>
								...
								<div class="portlet-body">
									...
									<form class="row g-3" action="<?=base_url();?>modul/berita/tambah-pengumuman.php" autocomplete="off" method="POST" id="simpanartikel" autocomplete="off">
										<div class="col-md-6">
	...
	$("#simpanartikel").unbind('submit').bind('submit', function() {
			...
			$.ajax({
				...
				data : {content:quillHtml,tanggal:tanggal,judul:judul},
				dataType : 'json',
				beforeSend: function(){	
				...
				success:function(response) {
					...
					if(response.success == true) {
						...
						setTimeout(function () {window.open("<?=base_url();?>","_self");},1000)
						// reset the form
					} else {
