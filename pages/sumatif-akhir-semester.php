<?php $data="Sumatif Akhir Semester";?>
...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
						...
						<div class="col-12">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									<h3 class="portlet-title">Sumatif Akhir Semester</h3>
	...
	$(document).ready(function(){
		...
		TabelRombel = $("#datatable-1").DataTable({ 
			...
			"paging":true,
			"responsive":true,
			"ajax": "modul/penilaian/nilai-sas.php?kelas=0&smt="+smt+"&mp="+mp+"&tapel="+tapel
		});
		...
		$('#mp').change(function(){
			...
			TabelRombel = $("#datatable-1").DataTable({ 
				...
				"paging":true,
				"responsive":true,
				"ajax": "modul/penilaian/nilai-sas.php?kelas="+kelas+"&smt="+smt+"&mp="+mp+"&tapel="+tapel
			});
