...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
	...
	$(document).ready(function(){
		...
		$('#mp').change(function(){
			...
			$.ajax({
				type : 'GET',
				url : 'modul/penilaian/harian-dtas.php',
	...
	function saveSumatif(editableObj,column,id,kelas,smt,tapel,mpid,tema,jenis) {
		...
		$.ajax({
			url: "modul/penilaian/saveHarianDTA.php",
			cache: false,
			data:'column='+column+'&value='+editableObj.innerHTML+'&id='+id+'&kelas='+kelas+'&smt='+smt+'&tapel='+tapel+'&mp='+mpid+'&lm='+tema+'&jns='+jenis,
