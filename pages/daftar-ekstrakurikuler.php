<?php $data="Daftar Ekstrakurikuler";?>
...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
							...
							<div class="portlet" id="status">
								<div class="portlet-header portlet-header-bordered">
									...
									<div class="portlet-addon">
										<button class="btn btn-sm btn-primary btn-icon" data-bs-toggle="modal" data-bs-target="#info"><i class="fas fa-plus"></i></button> 
                                    </div>
	...
	<div class="modal fade" id="info">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="modul/setting/tambah-ekskul.php" autocomplete="off" method="POST" id="buatmapel">
	...
	<div class="modal fade" id="edit-info">
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" action="modul/setting/update-ekskul.php" autocomplete="off" method="POST" id="ubahproyek">
	...
	$(document).ready(function(){
		...
		$('#edit-info').on('show.bs.modal', function (e) {
			...
			$.ajax({
				type : 'post',
				url : 'modul/setting/e_ekskul.php',
				data :  'rowid='+ rowid,
				beforeSend: function()
				{	
					$('#status').block({ message: '\n<div class="spinner-grow text-success"></div>\n<h1 class="blockui blockui-title">Tunggu sebentar...</h1>\n'});
