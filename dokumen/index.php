...
//Application Title
define('APP_TITLE', 'Al-Jannah File Manager');
...
$auth_users=array();
$sql4 = "select * from pengguna where verified='1'";
$query4 = $connect->query($sql4);
while($nk=$query4->fetch_assoc()){
	$auth_users[$nk['username']] = $nk['password'];
};
$auth_users['user'] ='$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO';
// Readonly users
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/dokumen/uploads';
...
$external = array(
    ...
    'css-highlightjs' => '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/styles/' . $highlightjs_style . '.min.css">',
  	'css-datatable' => '<link rel="stylesheet" href="//cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css" crossorigin="anonymous">',
    ...
    'js-jquery-datatables' => '<script src="//cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></script>',
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        ...
                                        <div class="text-center">
                                            <h1 class="card-title">Al-Jannah File Manajer</h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="mb-3">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">SD Islam Al-Jannah</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <?php else: ?>
            <div class="col-12"><a href="" target="_blank" class="float-right text-muted">Al-Jannah File Manajer <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
<head>
    ...
    <?php print_external('css-font-awesome'); ?>
  	<?php print_external('css-datatable'); ?>
...
<script>
    ...
    $(document).ready( function () {
        ...
        var $table = $('#main-table'),
            ...
            mainTable = $('#main-table').DataTable({paging: true, info: false, order: [[3, 'desc']], columnDefs: [{targets: _targets, orderable: false}]
        });
        // filter table
